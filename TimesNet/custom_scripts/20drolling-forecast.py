...
# === Your pre-split data ===
csv_src_train = Path(f"~/Dropbox/elvas-thesis/timesNet/data/timesnet_energy_var6_window{window}_testsize{test_size}_train.csv").expanduser()
csv_src_test  = Path(f"~/Dropbox/elvas-thesis/timesNet/data/timesnet_energy_var6_window{window}_testsize{test_size}_test.csv").expanduser()
